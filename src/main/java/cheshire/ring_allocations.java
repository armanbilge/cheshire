...
public final class ring_allocations {
	public static final GroupLayout layout = MemoryLayout
			.structLayout(io_uring_params.layout.withName("params"), io_uring_sqe.layout.withName("sqe"),
					io_uring_cqe.layout.withName("cqe"), io_uring_getevents_arg.layout.withName("arg"),
					get_data.layout.withName("data"), io_uring_rsrc_update.layout.withName("up"),
					ValueLayout.JAVA_INT.withName("flags"), ValueLayout.JAVA_INT.withName("nr_available"),
